...
public class SimpleMailSender  {
	...
	*/      
	public synchronized static boolean sendTextMail(MailSenderInfo mailInfo) {
		...
		try {
			...
			String nick = "";
			try {
				nick=javax.mail.internet.MimeUtility.encodeText(mailInfo.getNice());
...
//			mailMessage.setFrom(from);
			...
			for(String to : toaddress){
				...
				mailMessage.setRecipient(Message.RecipientType.TO,toa); 
				// 设置邮件消息的主题 
    ...
    /**    
      ...
      */
	public synchronized static boolean sendHtmlMail(MailSenderInfo mailInfo){
		// 判断是否需要身份认证
		MyAuthenticator authenticator = null;
		Properties pro = mailInfo.getProperties();
		//如果需要身份认证，则创建一个密码验证器
